...
public class request extends JPanel {
	...
	public request() {
		...
		editorPane_6.setFont(new Font("SimSun", Font.PLAIN, 15));
		...
		editorPane_7.setFont(new Font("SimSun", Font.PLAIN, 15));
