...
public class PassWord extends JPanel {
	...
	public PassWord() {
		...
		label_24.setFont(new Font("宋体", Font.PLAIN, 18));
		...
		lblhttpsijnueducn.setFont(new Font("宋体", Font.PLAIN, 18));
		panel_1.add(lblhttpsijnueducn);
		
		JLabel label_25 = new JLabel("账号：");
		label_25.setBounds(88, 266, 77, 27);
		label_25.setFont(new Font("宋体", Font.PLAIN, 18));
